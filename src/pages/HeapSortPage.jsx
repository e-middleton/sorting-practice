...
const HeapSortPage = () => {
    const instructions = <div className='bg-gray-100 p-2 mb-4 rounded-sm max-w-4xl lg:max-w-5xl'>
        <h1 className='font-roboto font-bold text-[20px]'>Instructions: </h1>
        <ul>
          <li className='font-roboto font-bold text-lg'> Double click to add an item to the heap.</li>
          <li className='font-roboto font-bold text-lg'> Double click the heap root to remove and add to the sorted section.</li>
          <li className='font-roboto font-bold mb-2 text-lg'>Drag items to swap them when preserving heap ordering.</li>
        </ul>
      ...
      <div className='bg-white mt-5 shadow-md mx-auto rounded-lg max-w-7xl py-2 my-5'>
        <div className='flex flex-col justify-start'>
          <div className='px-10 pb-5 mb-5 py-1 rounded-sm max-w-7xl ml-20'>
            ...
            <button onClick={resetArray} className='bg-gray-200 text-xl font-bold rounded-lg p-1 mb-5 hover:bg-gray-400'>
              Refresh Array
            </button>
          </div>
        </div>
